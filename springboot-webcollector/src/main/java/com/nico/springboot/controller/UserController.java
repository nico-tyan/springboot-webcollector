package com.nico.springboot.controller;
...
import com.nico.springboot.ErrorCode;
import com.nico.springboot.entity.User;
import com.nico.springboot.entity.enums.AgeEnum;
import com.nico.springboot.entity.enums.PhoneEnum;
import com.nico.springboot.service.IUserService;

/**
 * 代码生成器，参考源码测试用例：
 * <p>
 * test/generator/MysqlGenerator.java
 */
@RestController
@RequestMapping("/user")
